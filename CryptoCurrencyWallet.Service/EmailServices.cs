...
namespace CryptoCurrencyWallet.Service
{
    public class EmailServices : IEmailServices
    {
        ...
        //public async Task ConfirmationEmailHandler(UserManager<User> userManager, User user, string password) 
        //{
        //    var result = await userManager.CreateAsync(user, password);
        //    if (result.Succeeded)
        //    {
        //        var token = await userManager.GenerateEmailConfirmationTokenAsync(user);
        //        var confirmationLink = Uri.Action(nameof(ConfirmEmail), "Account", new { token, email = user.Email }, Request.Scheme);
